...
function calculateResult() {
  ...
  var imgSrc = "gs://test-tea-project/MIS_final_project_test/mbti-test/src/image/animal/" + animalName + ".png";
  ...
  var friendImgSrc = "gs://test-tea-project/MIS_final_project_test/mbti-test/src/image/animal/" + animalFriend + ".png";
  ...
  $("#shareBtn").on("click", function () {
    ...
    backgroundImage.src = "gs://test-tea-project/MIS_final_project_test/mbti-test/src/image/canvas_background.jpg";
